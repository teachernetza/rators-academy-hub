...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma de inglés con Labs interactivos, Conversation Clubs y Masterclasses. Acompañamiento experto con más de 6 años de experiencia." },
      { property: "og:title", content: "Teacher Netza Varo" },
      { name: "twitter:title", content: "Teacher Netza Varo" },
      { property: "og:description", content: "Plataforma de inglés con Labs interactivos, Conversation Clubs y Masterclasses. Acompañamiento experto con más de 6 años de experiencia." },
